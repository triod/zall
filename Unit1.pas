...
begin
  Res := MessageBox(
    Self.Handle
    , PChar('Ви справді бажаєте добавити разовий абонемент?')
    , PChar('Зал - Разовий абонемент')
...
DBGrid5.Columns[1].Title.Caption:='№ абонементу';
DBGrid5.Columns[2].Width:=150;
DBGrid5.Columns[2].Title.Caption:='ПІД';
DBGrid5.Columns[3].Width:=180;
DBGrid5.Columns[3].Title.Caption:='Адреса';
DBGrid5.Columns[4].Width:=120;
DBGrid5.Columns[4].Title.Caption:='Телефон';
DBGrid5.Columns[5].Width:=120;
DBGrid5.Columns[5].Title.Caption:='Тип абонементу';
DBGrid5.Columns[6].Width:=100;
DBGrid5.Columns[6].Title.Caption:='Дата створення';
DBGrid5.Columns[7].Width:=80;
DBGrid5.Columns[7].Title.Caption:='Ціна';
DBGrid5.Realign;
end;
...
DBGrid5.Columns[1].Width:=150;
DBGrid5.Columns[1].Title.Caption:='Назва';
DBGrid5.Columns[2].Width:=80;
DBGrid5.Columns[2].Title.Caption:='Ціна';
DBGrid5.Columns[3].Width:=80;
DBGrid5.Columns[3].Title.Caption:='Кількість';
DBGrid5.Columns[4].Width:=100;
DBGrid5.Columns[4].Title.Caption:='Дата створення';
DBGrid5.Realign;
end;
...
DBGrid5.Columns[1].Width:=150;
DBGrid5.Columns[1].Title.Caption:='Тип';
DBGrid5.Columns[2].Width:=80;
DBGrid5.Columns[2].Title.Caption:='Сума';
DBGrid5.Columns[3].Width:=100;
DBGrid5.Columns[3].Title.Caption:='Дата створення';
DBGrid5.Realign;
...
DBGrid5.Columns[1].Width:=150;
DBGrid5.Columns[1].Title.Caption:='ПІД';
DBGrid5.Columns[2].Width:=168;
DBGrid5.Columns[2].Title.Caption:='Заробітня плата';
DBGrid5.Columns[3].Width:=150;
DBGrid5.Columns[3].Title.Caption:='Адреса';
DBGrid5.Columns[4].Width:=110;
DBGrid5.Columns[4].Title.Caption:='Телефон';
DBGrid5.Columns[5].Width:=120;
DBGrid5.Columns[5].Title.Caption:='Дата народження';
DBGrid5.Columns[6].Width:=100;
DBGrid5.Columns[6].Title.Caption:='Дата створення';
...
RvProject1.Execute;
        ...
        ShowMessage('Будь-ласка виберіть по чому ви бажаєте зробити звіт');
    end;
end;
